...
{
    this->paintShip( painter, option,  widget);
    this->paintAsteroid( painter, option,  widget);
    this->paintBullet( painter, option,  widget);

}

void Station ::paintShip(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
